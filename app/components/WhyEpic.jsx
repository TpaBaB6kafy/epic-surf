      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-12 md:gap-12 text-center">
          {items.map((item, idx) => (
            ...
            >
              <div className="w-16 h-16 md:w-20 md:h-20 bg-[#2E2E2E] rounded-[24px] md:rounded-[30px] flex items-center justify-center text-epicRed shadow-sm border border-white/50 mb-6">
                {item.icon}
              </div>
