export const seoPageLinks = [
  {
    ...
    label: "Surf Lessons",
    description: "Beginner-friendly coaching near My Khe Beach.",
  },
  {
    href: "/surfing-danang",
    label: "Surfing in Da Nang",
    description: "Where to surf, when to go, and how to start.",
  },
  {
    href: "/surfboard-rental-danang",
    label: "Surfboard Rental",
    description: "Boards, local advice, and easy messenger booking.",
  },
  {
    href: "/my-khe-beach-surfing",
    label: "My Khe Beach Surfing",
    description: "A local guide to Da Nang's main beach surf area.",
  },
  {
    href: "/surf-guide",
    label: "Surf Guide",
    description: "Beginner tips, safety notes, and Da Nang surf info.",
  },
];

export const seoPages = {
  "surf-lessons-danang": {
    path: "/surf-lessons-danang",
    ...
    bookingService: "group",
    bookingLabel: "surf_lessons_page",
    sections: [
      {
    ...
    faq: [
      {
        ...
        answer: "No. The beginner lesson starts from the basics and uses equipment matched to your level.",
      },
      {
  ...
  "surfing-danang": {
    ...
    bookingService: "group",
    bookingLabel: "surfing_danang_page",
    ...
    faq: [
      {
        ...
        answer: "Board control, safe positioning, the pop-up movement, and how to choose small suitable waves.",
      },
      {
